...
const DarkNav = () => {
  ...
  return (
    ...
    display:scrolled ? "block" : "none"}} id='navbar-visible' 
    className={`border-none xl:h-[10vh] sticky-top`}>
      
         <Navbar style={{backgroundColor:"rgb(19,19,60)"}} id='top-rounded' key='lg' expand="lg" 
         className=" transi ps-4 py-3">
          <Container fluid className='align-items-center'>
            {/* logo */}
          <img id='change-logo' className='cursor-pointer' width={150} onClick={()=>navigate("/")} 
           src="../assest/meridawebsitelogowhite.png" alt="logo"/>
             {/* navbar */}
            ...
            >
              <Offcanvas.Header >
                ...
                <img onClick={()=>{navigate("/");setnav(false)}} width={150} 
                src={require("../assest/meridawebsitelogowhite.png")} 
                alt="logo" />
             </div>
                <img className='w-[20px] h-[18px]' onClick={()=>setnav(false)} src="../assest/close.png" alt="Close" />
                </Offcanvas.Title>
              </Offcanvas.Header>
              <Offcanvas.Body className='d-flex  flex-column justify-between'>
                ...
                <Nav className="lg:px-5 fw-semibold justify-content-start justify-content-between  flex-grow-1 pe-3">
                  <Nav.Link onClick={()=>{navigate("/");setnav(false) }} className='fontfam text-lg'><button className='fontfam text-lg text-slate-100'>Home</button></Nav.Link>
                  ...
                  className="drpbtn fontfam text-slate-100 text-lg">About 
  ...
  {/* <div style={{
    ...
    <Link to={"/about"} onClick={()=>{navigate("/about");setnav(false) }}
     className='text-decoration-none fs-6 fontfam text-lg w-full hover:scale-105 text-slate-100  hover:text-violet-600'>
      About Company</Link>
...
<Nav.Link>
  <div onMouseLeave={()=>setserviceboolean(false)} className="drpdown ">
   <button onClick={()=>setserviceboolean(!serviceboolean)}
    ...
    className="drpbtn fontfam text-slate-100 text-lg">Services 
       ...
       className='drpdown-content3 bg-transparent left-44 inline top-0'>
           ...
           onClick={()=>{navigate("/service/Investors");setnav(false);setserviceboolean(false) }} >
            Investors</Nav.Link>
                  ...
                  <Nav.Link onClick={()=>{navigate("/portfolio");setnav(false) }} className='position-relative fontfam text-lg'><button className='fontfam text-slate-100 text-lg'>Portfolio</button> </Nav.Link>
                  <Nav.Link onClick={()=>{navigate("/testimonial");setnav(false) }} className='position-relative fontfam text-lg'><button className='fontfam text-slate-100 text-lg'>Testimonial</button> </Nav.Link>
                  <Nav.Link onClick={()=>{navigate("/blogs");setnav(false) }} className='position-relative fontfam text-lg'><button className='fontfam text-slate-100 text-lg'>Blog</button> </Nav.Link>
                  <Nav.Link onClick={()=>{navigate("/contact");setnav(false) }} className='position-relative fontfam text-lg'><button className='fontfam text-slate-100 text-lg d-lg-none '>Contact</button> </Nav.Link>
...
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pinterest" viewBox="0 0 16 16">
  <path d="M8 0a8 8 0 0 0-2.915 15.452c-.07-.633-.134-1.606.027-2.297.146-.625.938-3.977.938-3.977s-.239-.479-.239-1.187c0-1.113.645-1.943 1.448-1.943.682 0 1.012.512 1.012 1.127 0 .686-.437 1.712-.663 2.663-.188.796.4 1.446 1.185 1.446 1.422 0 2.515-1.5 2.515-3.664 0-1.915-1.377-3.254-3.342-3.254-2.276 0-3.612 1.707-3.612 3.471 0 .688.265 1.425.595 1.826a.24.24 0 0 1 .056.23c-.061.252-.196.796-.222.907-.035.146-.116.177-.268.107-1-.465-1.624-1.926-1.624-3.1 0-2.523 1.834-4.84 5.286-4.84 2.775 0 4.932 1.977 4.932 4.62 0 2.757-1.739 4.976-4.151 4.976-.811 0-1.573-.421-1.834-.919l-.498 1.902c-.181.695-.669 1.566-.995 2.097A8 8 0 1 0 8 0"/>
      ...
      Contact
                ...
                <button className='xl:ms-5'  onClick={handleShow}>
                <img className='w-6' src="../assest/LOGOWHITE.png" alt="Awesome Image"/>
                 </button>
            </div>
          </Container>
          {/* Logo off canvas */}
      ...
      className="p-4 lg:w-2/5 transi text-black">
        <Offcanvas.Header closeButton className=''>
          ...
          <div className='mx-auto mx-sm-0'>
             <img width={130} src="../assest/png-01.png" alt="logo"/>
             </div>
          </Offcanvas.Title>
          </Offcanvas.Header>
        <Offcanvas.Body className='d-flex flex-column justify-between'>
